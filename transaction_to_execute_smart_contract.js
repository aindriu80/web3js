...
const web3 = new Web3(
  "https://ropsten.infura.io/v3/abbe691d210c470bbb9e2956e2f82c49"
);
...
const election_address = "0x9c446F9830CAa089ec44BaEB1590d92Bc909b8bf";
const election_abi = [
  {
    constant: true,
    inputs: [
...
// electionContract.methods.candidateCount().call((error, result) => {
//   console.log(result);
// });
