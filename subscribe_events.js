...
const kitties_contract = new web3.eth.Contract(kitties_abi, kitties_address);

// kitties_contract.events.allEvents({ fromBlock: "latest" }, (error, result) => {
//   console.log(result);
// });

kitties_contract.events.Transfer({ fromBlock: "latest" }, (error, result) => {
  console.log(result);
});
